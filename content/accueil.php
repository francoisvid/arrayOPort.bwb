<main role="main">
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="first-slide" src="http://www.lacharpiniere.com/image/carrousel/slide_107.jpg" style="width:100%" alt="First slide">
                <div class="container">
            ...
            <div class="carousel-item">
                <img class="second-slide" src="http://www.llperreal.com/wp-content/uploads/2018/02/DSC_6026-1-1800x500.jpg" style="width:100%" alt="Second slide">
                <div class="container">
            ...
            <div class="carousel-item">
                <img class="third-slide" src="http://www.lacharpiniere.com/image/carrousel/slide_81.JPG" style="width:100%" alt="Third slide">
                <div class="container">
    ...
    <div class="container marketing">
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">Paul Bocuse</h2>
                <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" style="width: 500px; height: 500px;" src="http://www.slate.fr/sites/default/files/38_3.jpg" data-holder-rendered="true">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading">Gille Goujon</h2>
                <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
            </div>
            <div class="col-md-5 order-md-1">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="https://i.pinimg.com/736x/01/8f/34/018f34ffe0a89998e463fd420689fe45--dessert-restaurants-midi.jpg" data-holder-rendered="true" style="width: 500px; height: 500px;">
            </div>
        </div>
        ...
        <div class="row featurette">
            <div class="col-md-7">
                <h2 class="featurette-heading">Cyril Lignac</h2>
                <p class="lead">Donec ullamcorper nulla non metus auctor fringilla. Vestibulum id ligula porta felis euismod semper. Praesent commodo cursus magna, vel scelerisque nisl consectetur. Fusce dapibus, tellus ac cursus commodo.</p>
            </div>
            <div class="col-md-5">
                <img class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="500x500" src="http://himacs.eu/sites/himacs/files/styles/dd_news_media_lightbox/public/newsroom/pictures/hi-macs_librije_binnewerk3221.jpg?itok=LAfyQTrO" data-holder-rendered="true" style="width: 500px; height: 500px;">
            </div>
        </div>
    ...
    <script src="../fonctions/scriptButtonAccueil/suiteButton.js" type="text/javascript"></script>
    <!-- FOOTER -->
    <footer class="container">
        <p class="float-right"><a href="#">Back to top</a></p>
        <p>© 2018-2019 François, Inc. · <a href="#">Privacy</a> · <a href="#">Terms</a></p>
    </footer>
</main>